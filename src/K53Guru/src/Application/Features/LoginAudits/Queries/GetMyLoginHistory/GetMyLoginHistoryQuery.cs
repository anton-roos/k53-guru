...
using K53Guru.Application.Features.LoginAudits.Caching;
using K53Guru.Application.Features.LoginAudits.DTOs;
using K53Guru.Application.Features.LoginAudits.Specifications;
using K53Guru.Domain.Identity;

namespace K53Guru.Application.Features.LoginAudits.Queries.GetMyLoginHistory;
