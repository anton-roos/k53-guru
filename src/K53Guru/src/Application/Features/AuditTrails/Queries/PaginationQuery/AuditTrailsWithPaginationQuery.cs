...
using K53Guru.Application.Features.AuditTrails.Caching;
using K53Guru.Application.Features.AuditTrails.DTOs;
using K53Guru.Application.Features.AuditTrails.Specifications;

namespace K53Guru.Application.Features.AuditTrails.Queries.PaginationQuery;
