...
namespace K53Guru.Infrastructure.Extensions;
    ...
    public static void RegisterSerilog(this WebApplicationBuilder builder)
    {
        ...
        builder.Host.UseSerilog((context, configuration) =>
            configuration.ReadFrom.Configuration(context.Configuration)
                ...
                .MinimumLevel.Override("K53Guru.Server.UI.Services.Fusion.UserSessionTracker", LogEventLevel.Error)
                .MinimumLevel.Override("K53Guru.Server.UI.Services.Fusion.OnlineUserTracker", LogEventLevel.Error)
